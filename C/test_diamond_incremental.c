...
void test_indents_is_list_of_indentation_for_each_line_of_the_diamond() {
	...
	diamond_indents('A', buffer, &length);
	...
	//diamond_indents('B', buffer, &length);
	...
	//diamond_indents('C', buffer, &length);
	...
	//diamond_indents('D', buffer, &length);
